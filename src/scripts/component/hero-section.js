...
//     set searchPokemon(searchPokemon) {
//         this._searchPokemon = searchPokemon;
//     }
...
//           <img src="assets/dicedex.svg" alt="" />
//           <div class="boxes">
...
//         $(function () {
//             let pokemonSearch = $('hero-section').get(0).shadowDOM.querySelector('#searchElement');
...
//             })
//         });
//         this.shadowDOM.querySelector('#searchButtonElement').addEventListener('click', this._searchPokemon)
//     }
